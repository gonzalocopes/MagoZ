...
function App() {
  ...
  useEffect(() => {
    ...
    link.href = "/images/burgerbella/burger_bella_logo.png";
  }, []);

  return (
    <div className="bg-body-tertiary min-vh-100">
      <Helmet>
        <title>Burger Bella | Las mejores hamburguesas</title>
        <link rel="icon" type="image/png" href="/images/burgerbella/burger_bella_logo.png" sizes="16x16" />
      </Helmet>
