      ...
      <div className="container">
        ...
        >
          ...
          <span
            ...
            style={{
              ...
              fontFamily: "'Impact', sans-serif", // Stronger font if possible, or keep default
              letterSpacing: "1px"
            }}
          >
            {clientConfig.nombre}
        ...
        >
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-light fw-bold d-flex align-items-center"
                href="#cart"
                onClick={handleNavClick}
              >
                <span>Mi pedido</span>
                {cartCount > 0 && (
                  <span className="badge bg-danger ms-2"> {/* Orange/Red badge for contrast */}
                    {cartCount}
                  </span>
                )}
              </a>
