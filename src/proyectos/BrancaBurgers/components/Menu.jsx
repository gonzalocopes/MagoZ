...
import { promos, hamburguesas, papas, bebidas, milanesas, infantil, pastas } from "../data/products";
...
export default function Menu({ onAddToCart, isClosed }) {
  const categories = [
    ...
    { id: "infantil", label: "Menú Infantil 🧒", products: infantil },
    { id: "pastas", label: "Pastas 🍝", products: pastas },
    // { id: "promos", label: "Promos 🔥", products: promos }, // Comentado si está vacío
