...
function App() {
  ...
  useEffect(() => {
    ...
    link.href = "/images/branca_logo.png";
  }, []);

  return (
    <div className="bg-body-tertiary min-vh-100">
      <Helmet>
        <title>BrancaBurgers | Las mejores hamburguesas</title>
        <link rel="icon" type="image/png" href="/images/branca_logo.png" sizes="16x16" />
      </Helmet>
