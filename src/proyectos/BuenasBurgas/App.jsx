...
function App() {
  ...
  // ⬇️ Ahora las sugerencias del modal son los extras O los sabores si el producto los tiene
  const upsellItems = lastProduct?.flavors || extras;
  ...
  useEffect(() => {
    ...
    link.href = "/images/buenas/logo_buenas.png";
  }, []);

  return (
    <div className="bg-body-tertiary min-vh-100">
      <Helmet>
        <title>Buenas Burgas | Las mejores hamburguesas</title>
        <link rel="icon" type="image/png" href="/images/buenas/logo_buenas.png" sizes="16x16" />
      </Helmet>
